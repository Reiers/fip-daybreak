...
So effective multiplier $= \frac{\text{code\_value}}{\text{QBM}} = \frac{100}{10} = 10\times$. Our interpolation transitions the code value $100 \to 10$, yielding effective $10\times \to 1\times$.
